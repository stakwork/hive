...
export const optionalEnvVars = {
  ...
  STAKWORK_PROTECT_WORKFLOW_ID: process.env.STAKWORK_PROTECT_WORKFLOW_ID,
  ...
  STAKWORK_CONCEPT_REVIEW_WORKFLOW_ID: process.env.STAKWORK_CONCEPT_REVIEW_WORKFLOW_ID,
  ...
  STAKWORK_CNH_INGEST_WORKFLOW_ID: process.env.STAKWORK_CNH_INGEST_WORKFLOW_ID,
