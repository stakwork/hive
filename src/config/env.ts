...
export const optionalEnvVars = {
  ...
  // Native dual-target Prompt node graph writer (replaces WORKFLOW_GRAPH_PROMPT_STORAGE_ID).
  // Each target requires a Jarvis URL + API token.  Both must be set for full graph coverage.
  PROMPT_GRAPH_TARGET_1_URL: process.env.PROMPT_GRAPH_TARGET_1_URL,
  PROMPT_GRAPH_TARGET_1_API_KEY: process.env.PROMPT_GRAPH_TARGET_1_API_KEY,
  PROMPT_GRAPH_TARGET_2_URL: process.env.PROMPT_GRAPH_TARGET_2_URL,
  PROMPT_GRAPH_TARGET_2_API_KEY: process.env.PROMPT_GRAPH_TARGET_2_API_KEY,
  ...
  STAKWORK_HARVEY_EVAL_WORKFLOW_ID: process.env.STAKWORK_HARVEY_EVAL_WORKFLOW_ID,
  STAKWORK_HARVEY_RECURSION_WORKFLOW_ID: process.env.STAKWORK_HARVEY_RECURSION_WORKFLOW_ID,
