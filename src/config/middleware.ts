...
export const ROUTE_POLICIES: ReadonlyArray<RoutePolicy> = [
  ...
  { path: "/api/protect/webhook", strategy: "prefix", access: "webhook" },
  { path: "/api/lingo/extraction/collect", strategy: "exact", access: "webhook" },
  { path: "/api/lingo/extraction/upsert", strategy: "exact", access: "webhook" },
  ...
  { path: "/api/tasks/*/audit/callback", strategy: "pattern", access: "webhook" },
  ...
  { path: "/api/gateway/evals", strategy: "prefix", access: "webhook" }, // self-authenticated via workspace API key (covers base + all sub-paths)
  { path: "/api/webhook/prompt-eval", strategy: "prefix", access: "webhook" },
