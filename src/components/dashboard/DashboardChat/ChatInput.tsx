...
export function ChatInput({
  ...
  return (
    <form
      ...
      onDrop={handleDrop}
      className="relative flex justify-center items-center gap-2 w-full px-4"
    >
      {/* Drag overlay */}
      {isDragging && (
      ...
      <div className="relative w-full max-w-[70vw] sm:max-w-[450px] md:max-w-[500px] lg:max-w-[600px]">
        <textarea
          ...
          disabled={disabled}
          rows={rows}
          className={`w-full px-4 py-[0.625rem] pr-12 rounded-2xl bg-background/5 border border-border/20 text-sm text-foreground/95 placeholder:text-muted-foreground/40 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all resize-none ${
