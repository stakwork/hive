...
export function WorkspaceMembersPreview({
  ...
  return (
    <div className={`flex items-center gap-2 px-3 py-2 rounded-lg border border-border bg-card/95 backdrop-blur-sm transition-all duration-300 max-h-[120px] overflow-y-auto pointer-events-auto ${loading ? 'opacity-0' : 'opacity-100'}`}>
      {/* Avatar list */}
