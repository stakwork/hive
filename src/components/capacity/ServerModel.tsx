      ...
      <group position={[0, 0, 1.26]}>
        ...
        <group position={[-0.4, 0, 0.025]}>
          ...
          <group position={[-0.4, -0.02, 0.01]}>
            <Text position={[0, 0, 0]} fontSize={0.05} color="#94a3b8" anchorX="left" anchorY="middle">
              CPU
            </Text>
            {/* Bar Background */}
            ...
            {/* Percentage Text */}
            <Text position={[0.45, 0, 0.002]} fontSize={0.035} color="white" anchorX="center" anchorY="middle">
              {Math.round(cpuVal)}%
            </Text>
          </group>

          {/* Memory Bar & Text */}
          <group position={[-0.4, -0.1, 0.01]}>
            <Text position={[0, 0, 0]} fontSize={0.05} color="#94a3b8" anchorX="left" anchorY="middle">
              MEM
            </Text>
            {/* Bar Background */}
        ...
        <group position={[0.35, 0, 0.025]}>
          ...
          {/* Subdomain */}
          {subdomain && (
            <Text position={[-0.22, 0.1, 0.01]} fontSize={0.045} color="#64748b" anchorX="left" anchorY="middle">
          ...
          {/* Repository Name */}
          {repoName && (
            <Text position={[-0.22, 0.02, 0.01]} fontSize={0.035} color="#94a3b8" anchorX="left" anchorY="middle">
          ...
          {isUsed && userInfo && (
            <Text position={[-0.22, -0.08, 0.01]} fontSize={0.04} color="#60a5fa" anchorX="left" anchorY="middle">
