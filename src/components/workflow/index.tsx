...
export default function App(workflowApp: WorkflowAppProps) {
  ...
  useEffect(() => {
    ...
    const handleStepClick = (event: MouseEvent) => {
      ...
      const transitionsArray = Array.isArray(transitions) ? transitions : Object.values(transitions);
  ...
  // Context menu disabled - functionality not needed in Hive
  const onPaneContextMenu = useCallback((event: any) => {
    // Just prevent native context menu, don't show custom menu
    event.preventDefault();
  }, []);
  ...
  // Node context menu disabled - functionality not needed in Hive
  const onNodeContextMenu = useCallback((event: any, _node: any) => {
    // Just prevent native context menu, don't show custom menu
    event.preventDefault();
  }, []);
