  ...
  describe("GET /api/github/app/check", () => {
    describe("Success scenarios", () => {
      test("should return hasPushAccess=true when user has push permissions", async () => {
        ...
        const request = createGetRequest("http://localhost:3000/api/github/app/check", {
      ...
      test("should return hasPushAccess=false when repository not accessible through installation", async () => {
        ...
        expect(data.error).toBe(
          "Repository 'test-owner/test-repo' is not accessible through the GitHub App installation. Please ensure the repository is included in the app's permissions or reinstall the app with access to this repository.",
        );
