...
// Stub child components to focus tests on top-bar behaviour
vi.mock(
  "@/app/w/[slug]/learn/lingo/components/LingoCard",
  () => ({
...
vi.mock(
  "@/app/w/[slug]/learn/lingo/components/NeighborView",
  () => ({
...
vi.mock(
  "@/app/w/[slug]/learn/lingo/components/Breadcrumb",
  () => ({
...
vi.mock(
  "@/app/w/[slug]/learn/lingo/components/CreateLingoNodeDialog",
  () => ({
...
describe("LingoExplorer (/w/[slug]/learn/lingo) — Run Extraction button", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    setupWorkspace();
    setupNodesFetch();
    ...
    await waitFor(() => {
      expect(mockToast).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          description: "Lingo nodes will update shortly.",
        }),
      );
    });
  });
