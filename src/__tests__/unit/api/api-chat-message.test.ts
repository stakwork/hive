...
describe("POST /api/chat/message", () => {
  ...
  function createAuthenticatedPostRequest(url: string, body: object): NextRequest {
  ...
  describe("Authentication", () => {
    ...
    it("should return 401 if no auth headers present (unauthenticated)", async () => {
      const request = new NextRequest("http://localhost:3000/api/chat/message", {
        method: "POST",
        body: JSON.stringify({ taskId: mockTaskId, message: mockMessage }),
      });
  ...
  describe("Input Validation", () => {
    it("should return 400 if message is missing", async () => {
      const request = createAuthenticatedPostRequest("http://localhost:3000/api/chat/message", { taskId: mockTaskId });
    ...
    it("should return 400 if taskId is missing", async () => {
      const request = createAuthenticatedPostRequest("http://localhost:3000/api/chat/message", { message: mockMessage });
    ...
    it("should accept empty message if there are artifacts", async () => {
      ...
      const request = createAuthenticatedPostRequest("http://localhost:3000/api/chat/message", {
          taskId: mockTaskId,
          message: "",
          artifacts,
        });
  ...
  describe("GitHub Integration", () => {
    it("should include GitHub credentials in Stakwork payload", async () => {
      ...
      const body = JSON.parse(fetchCall![1]!.body as string).project;
