...
vi.mock("@/app/w/[slug]/task/[...taskParams]/artifacts/form", () => ({
  FormArtifact: ({
    ...
    <div data-testid="form-artifact" data-message-id={messageId} data-disabled={isDisabled}>
      Form Artifact
    ...
    <div data-testid="longform-artifact-panel" data-workflow-url={workflowUrl}>
      ...
      {artifacts.map((artifact) => (
        <div key={artifact.id} data-testid={`longform-artifact-${artifact.id}`}>
          {(artifact.content as LongformContent)?.title && <h3>{(artifact.content as LongformContent).title}</h3>}
...
describe("ChatMessage", () => {
  ...
  describe("Message Rendering", () => {
    it("renders assistant message correctly", () => {
      ...
      render(<ChatMessage message={message} onArtifactAction={mockOnArtifactAction} />);
  ...
  describe("Form Artifacts", () => {
    ...
    it("handles form artifact interactions", () => {
      const formContent: FormContent = {
        actionText: "Choose an option",
        webhook: "https://example.com/webhook",
        options: [{ actionType: "button", optionLabel: "Click me", optionResponse: "clicked" }],
      };
    ...
    it("shows selected option when reply message matches", () => {
      const formContent: FormContent = {
        actionText: "Choose an option",
        webhook: "https://example.com/webhook",
        options: [{ actionType: "button", optionLabel: "Selected Option", optionResponse: "selected_response" }],
      };
      ...
      render(<ChatMessage message={message} replyMessage={replyMessage} onArtifactAction={mockOnArtifactAction} />);
  ...
  describe("Mixed Content", () => {
    it("renders message with both text and artifacts", () => {
      const formContent: FormContent = {
        actionText: "Choose an option",
        webhook: "https://example.com/webhook",
        options: [{ actionType: "button", optionLabel: "Option 1", optionResponse: "response1" }],
      };
