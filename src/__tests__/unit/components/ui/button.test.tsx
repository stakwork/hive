...
describe("Button", () => {
  ...
  describe("Button Variants", () => {
    const variants: Array<ButtonProps["variant"]> = ["default", "destructive", "outline", "secondary", "ghost", "link"];
  ...
  describe("Props Forwarding", () => {
    test("forwards standard button props", () => {
      ...
      render(
        <Button onClick={handleClick} disabled={true} type="submit" aria-label="Submit form" data-testid="submit-btn">
          Submit
        </Button>,
      );
