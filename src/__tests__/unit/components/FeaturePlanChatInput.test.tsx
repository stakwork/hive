...
// ── Minimal FeaturePlanChatInput (mirrors real implementation post-refactor) ──

function TestFeaturePlanChatInput({
  onSend,
  disabled = false,
}: {
...
describe("FeaturePlanChatInput — CSS-native field-sizing-content", () => {
  const noop = async () => {};

  it("has field-sizing-content class and no inline height style on render", () => {
    render(<TestFeaturePlanChatInput onSend={noop} />);
  ...
  it("does not submit on Shift+Enter", async () => {
    ...
    render(<TestFeaturePlanChatInput onSend={onSend} />);
    const ta = screen.getByTestId("chat-input") as HTMLTextAreaElement;
