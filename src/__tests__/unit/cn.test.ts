...
describe("cn utility function", () => {
  ...
  describe("conditional classes", () => {
    ...
    it("should handle mixed string and object arguments", () => {
      expect(cn("base-class", { "conditional-class": true, "excluded-class": false })).toBe(
  ...
  describe("complex real-world scenarios", () => {
    ...
    it("should handle grid layout classes with breakpoints", () => {
      expect(
        cn("grid", "grid-cols-1 md:grid-cols-2 lg:grid-cols-3", "gap-4 md:gap-6", { "xl:grid-cols-4": true }),
    ...
    it("should handle deeply nested structures", () => {
      expect(
        cn([
          ...
          ["nested-1", { "nested-condition": true }],
        ]),
