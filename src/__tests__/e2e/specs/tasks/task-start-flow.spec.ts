 ...
 * 1. Create workspace with user via scenario
 * 2. Sign in with mock auth
 * 3. Navigate to new task page
 * 4. Fill task start input
 * 5. Submit to create task
 * 6. Verify task creation and navigation to task detail page
 */
test.describe('Task Start Flow', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    // Create workspace and user for testing
