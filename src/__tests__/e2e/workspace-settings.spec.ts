...
test("User interaction replay", async ({ page }) => {
  ...
  await page.waitForTimeout(2666);
  ...
  await page.waitForTimeout(2739);
  ...
  // Assert element contains text: div.flex.items-center
  await expect(page.locator("div.flex.items-center")).toContainText(
    "mock-stakgraph-123",
  );

  await page.waitForTimeout(2501);
