        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              value={feature.brief || ""}
              onChange={(e) => setFeature({ ...feature, brief: e.target.value } as any)}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => setFeature({ ...feature, requirements: e.target.value } as any)}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => setFeature({ ...feature, architecture: e.target.value } as any)}
