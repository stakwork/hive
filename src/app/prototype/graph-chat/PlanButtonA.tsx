...
/**
 * Variation A — Wand2 + "Generate Plan"
 * Clean 1-to-1 swap: Lightbulb → Wand2, "Create Feature" → "Generate Plan".
 * Same pill shape and colour treatment as the rest of the action row.
 * No animation — just the right label + icon.
 */

import { useState, useRef } from "react";
import { Send, X, Eye, Share2, Image as ImageIcon, Zap, Wand2 } from "lucide-react";
...
export default function PlanButtonA() {
