...
const mockScripts = new Map([
  [
    1,
    {
      ...
      public_url: "https://stakwork-uploads.s3.us-east-1.amazonaws.com/scripts/admin/data_transform_script.py",
  ...
  [
    2,
    {
      ...
      public_url: "https://stakwork-uploads.s3.us-east-1.amazonaws.com/scripts/admin/api_response_parser.py",
  ...
  [
    3,
    {
      ...
      public_url: "https://stakwork-uploads.s3.us-east-1.amazonaws.com/scripts/admin/text_sanitizer.py",
  ...
  [
    4,
    {
      ...
      public_url: "https://stakwork-uploads.s3.us-east-1.amazonaws.com/scripts/admin/workflow_result_formatter.py",
