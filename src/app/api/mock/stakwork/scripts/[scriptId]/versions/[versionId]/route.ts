...
const mockVersionData: Record<number, { id: number; script_id: number; value: string; description: string; created_at: string; whodunnit: string | null; event: string | null }> = {
  1: {
    id: 1,
    script_id: 1,
