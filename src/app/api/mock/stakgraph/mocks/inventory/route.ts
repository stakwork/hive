...
const mockServices = [
  ...
  },
  {
    ...
    linked_files: [
      ...
      "stakwork/hive/src/config/services.ts",
      "stakwork/hive/src/config/env.ts",
      "stakwork/hive/docs/PUSHER_MOCK_ENDPOINTS.md",
      "stakwork/hive/src/lib/mock/pusher-state.ts",
      "stakwork/hive/src/app/api/mock/pusher/status/route.ts",
      "stakwork/hive/src/__tests__/unit/lib/mock/pusher-state.test.ts",
      "stakwork/hive/src/services/janitor.ts",
      "stakwork/hive/src/services/stakwork-run.ts",
