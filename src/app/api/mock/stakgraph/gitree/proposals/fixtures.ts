...
function initialProposals(): MockProposal[] {
  return [
    ...
    {
      id: "proposal-update-workspace-1",
      action: "update",
      status: "pending",
      conceptId: "stakwork/hive/workspace",
      documentation:
        "Multi-tenant workspace with role-based access control (RBAC). Workspaces now support a public view mode for unauthenticated visitors.",
      baseDocs: "Multi-tenant workspace with role-based access control (RBAC).",
      rationale: "PR #318 added public workspace viewing.",
      source: "https://github.com/stakwork/hive/pull/318",
      prNumbers: [318],
      sessionIds: [],
    ...
    {
      id: "proposal-create-pool-1",
      action: "create",
      status: "pending",
      name: "Pool Manager",
      description: "Pod pool allocation and health for agent workloads",
      documentation:
        "Pool Manager claims, health-checks, and recycles pods for agent sessions. Credentials stay on the server.",
      rationale: "PR #322 extracted pool management from the swarm concept.",
      source: "https://github.com/stakwork/hive/pull/322",
      prNumbers: [322],
      sessionIds: [],
      createdAt: "2025-08-11T13:40:00.000Z",
      repo: "stakwork/hive",
    },
    {
      id: "proposal-update-swarm-1",
      action: "update",
      status: "pending",
      conceptId: "stakwork/hive/swarm",
      documentation:
        "Pod and swarm lifecycle management for AI agent workloads, including auto-learn toggles per workspace.",
      baseDocs: "Pod and swarm lifecycle management for AI agent workloads.",
      rationale: "PR #330 documented the auto-learn swarm setting.",
      source: "https://github.com/stakwork/hive/pull/330",
      prNumbers: [330],
      sessionIds: [],
    ...
    {
      id: "proposal-create-flags-1",
      action: "create",
      status: "pending",
      name: "Feature Flags",
      description: "Env-based feature flags with role gating",
      documentation:
        "Feature flags are env-based with optional role gating via `useFeatureFlag()`. Client flags use the `NEXT_PUBLIC_` prefix.",
      rationale: "PR #341 documented the feature-flag convention.",
      source: "https://github.com/stakwork/hive/pull/341",
      prNumbers: [341],
      sessionIds: [],
      createdAt: "2025-08-13T15:25:00.000Z",
      repo: "stakwork/hive",
    },
  ];
}
