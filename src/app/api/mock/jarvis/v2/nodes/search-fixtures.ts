...
export const mockSearchNodes: MockSearchNode[] = [
  ...
  {
    ref_id: "protect-finding-open-sql",
    node_type: "SecurityFinding",
    name: "SQL injection in login handler",
    properties: {
      node_key: "https://github.com/acme/hive|src/auth/login.ts|security|a1b2c3d4e5f6a7b8",
      id: "https://github.com/acme/hive|src/auth/login.ts|security|a1b2c3d4e5f6a7b8",
      category: "security",
      severity: "critical",
      area: "auth",
  ...
  {
    ref_id: "protect-finding-secret-key",
    node_type: "SecurityFinding",
    name: "Hardcoded API key",
    properties: {
      node_key: "https://github.com/acme/hive|src/lib/client.ts|secret|b2c3d4e5f6a7b8c9",
      id: "https://github.com/acme/hive|src/lib/client.ts|secret|b2c3d4e5f6a7b8c9",
      category: "secret",
      severity: "high",
      area: "config",
      ...
      description: "A live API key is committed in source.",
      evidence: "const KEY = 'sk-live-example'",
      recommendation: "Move the key to environment configuration and rotate it.",
  ...
  {
    ref_id: "protect-finding-stale-dup",
    node_type: "SecurityFinding",
    name: "Duplicated auth helper",
    properties: {
      node_key: "https://github.com/acme/hive|src/auth/copy.ts|code-dup|c3d4e5f6a7b8c9d0",
      id: "https://github.com/acme/hive|src/auth/copy.ts|code-dup|c3d4e5f6a7b8c9d0",
      category: "code-dup",
      severity: "medium",
      area: "auth",
      file: "src/auth/copy.ts",
      line: 8,
      title: "Duplicated auth helper",
      description: "Near-identical helper exists in two modules.",
      evidence: "copySession() matches persistSession() in src/auth/session.ts",
      recommendation: "Collapse the helpers into one shared function.",
      verification: "reported",
      status: "stale",
      repositoryUrl: "https://github.com/acme/hive",
    },
  ...
  {
    ref_id: "protect-finding-supply-chain",
    node_type: "SecurityFinding",
    name: "Unpinned dependency",
    properties: {
      node_key: "https://github.com/acme/hive|package.json|supply-chain|d4e5f6a7b8c9d0e1",
      id: "https://github.com/acme/hive|package.json|supply-chain|d4e5f6a7b8c9d0e1",
      ...
      description: "A production dependency uses a floating range.",
      evidence: "\"left-pad\": \"*\"",
      recommendation: "Pin the version and enable lockfile verification.",
      verification: "reported",
      status: "open",
      repositoryUrl: "https://github.com/acme/hive",
    },
