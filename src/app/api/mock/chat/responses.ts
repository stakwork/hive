import { makeRes, createArtifact, ArtifactType, PYTHON_CODE, JSON_CODE, REPOMAP, MARKDOWN_EXAMPLE } from "./helpers";
...
export function generateCodeResponse() {
  ...
  return makeRes("Perfect! I've created the connection leak monitor implementation. Here's what I've built:", [
    createArtifact({
      id: "code-artifact-1",
      messageId: messageId,
...
export function generateFormResponse() {
  ...
  return makeRes("I'll help you build a connection leak monitor. Here's my plan:", [
    createArtifact({
      id: "form-artifact-1",
      messageId: messageId,
...
export function generateChatFormResponse() {
  ...
  return makeRes("I need some additional information to proceed with your request:", [
    createArtifact({
